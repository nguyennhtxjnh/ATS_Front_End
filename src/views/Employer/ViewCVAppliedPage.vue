<template>
  <EmployerMainLayout>
    <v-layout row wrap>
      <DetailCVApplied></DetailCVApplied>
...
<script>
  ...
  import DetailCVApplied from "../../components/Employer/CVapplied/DetailCVApplied";

  export default {
    name: "ViewCVAppliedPage",
    components: {DetailCVApplied, DetailCV, EmployerMainLayout},
    data: function () {
      return {
        userId: '',
