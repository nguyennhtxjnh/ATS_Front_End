<template>
  <v-container fluid class="pt-0">
    ...
    <v-dialog
      ...
      max-width="500px">
      <v-card>
        <v-card-title class="headline orange"><b style="color: white">Kích hoạt công ty</b></v-card-title>

        <v-divider></v-divider>
        <v-card-text>
          <v-flex xs12 class="justify-center align-center"><p style="text-align: center">Bạn muốn kích hoạt công ty
            này?</p></v-flex>
        </v-card-text>
    ...
    <v-dialog
      ...
      <v-card>
        ...
        <v-divider></v-divider>
        <v-card-text>
          <v-flex xs12 class="justify-center align-center"><p style="text-align: center">Bạn muốn cấm công ty này?</p>
          </v-flex>
        </v-card-text>
